...
class tracker:
    ...
    def stackTrack(self, structLog, nextStructLog = None, tags = None, info = None) -> None:
        # aa = len(self.stackTracker.stack)
        # bb = len(structLog["stack"])
        # if aa != bb:
        #     sys.exit("Tracker Error: stacker length {} not equal to structLog stack length {}".format(aa, bb))
        ...
        if opcode == "AND":
            ...
            shiftInt = int(shift, base = 16)
            # if shiftInt % 8 != 0:
            #     sys.exit("Tracker Error: SHR with shift % 8 != 0")
            firstEntry = self.stackTracker.stack[-1]
            secondEntry = self.stackTracker.stack[-2]
            self.stackTracker.pop(2)
            ...
            # if hashValue == '0x175ae2e7110df3644daf25235f8a30489611f42116e1143164cddbda86763564':
            #     print("now is the time")
            ...
            # if key == '0xc2575a0e9e593c00f959f8c92f12db2869c3395a3b0502d05e2516446f71f85c':
            #     print("now is the time")
            ...
            # if key == '0x175ae2e7110df3644daf25235f8a30489611f42116e1143164cddbda86763564':
            #     print("now is the time")
