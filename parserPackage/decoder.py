...
class decoder:
    ...
    def decodeSimpleABI(self, types: list, data: str) -> list:
        ...
        bytes__ = bytes.fromhex(data)
        decodedData = decode(types, bytes__)
...
if __name__ == "__main__":
    ...
    # types = ['uint256', 'uint8', 'uint256', 'uint256']
    # data = ""
    # data = data[12:]
    # bytes__ = bytes.fromhex(data)
    # decodedData = decode(types, bytes__)
    # mylist = list(decodedData)
    ...
    # # give a range of msg.data, and a list of types, return the type of msg.data
    # source = ('msg.data', 100, 132, 700658131, 2075)
    # metaData = {'value': 700658131, 'type': 'uint256', 'gas': 154290, 'pc': 6295, 'targetFunc': 'withdrawERC20For'}
    # types = ["uint256", "address", "address", "uint256", "bytes"]

    # index = 4 # for func selector
    # for type in types:
    #     start = index
    #     end = index + decoder.typeLengths[type]
    #     print("start = {}, end = {}".format(start, end))
    #     if start == source[1] and end == source[2]:
    #         print("Found: ", type)
    #         sys.exit(0)
    #     index = end
    ...
    #     start = index
    #     # end = index + decoder.typeLengths[type]
    #     end = index + decoder.type2length(type)
    #     print("start = {}, end = {}".format(start, end))
    #     if start == source[1] and end == source[2]:
    #         print("Found: ", type)
    #         sys.exit(0)
